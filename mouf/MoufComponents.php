...
$moufManager->getConfigManager()->setConstantsDefinitionArray(array (
  ...
  'SECRET' => 
  array (
    'defaultValue' => 'nItqx2y0VQL23UsOpbTl',
    'type' => 'string',
...
$moufManager->addComponentInstances(array (
  ...
  'magentoTemplate' => 
  array (
    'class' => 'Mouf\\Integration\\Magento\\MagentoTemplate',
    'external' => false,
    'weak' => false,
    'setterProperties' => 
    array (
      'setTemplate' => 
      array (
        'value' => 'page/2columns-left.phtml',
        'type' => 'string',
        'metadata' => 
        array (
        ),
    ...
    array (
      ...
      'setTemplateRenderer' => 'moufgentoRenderer',
    ),
  ),
  ...
  array (
    ...
    array (
      0 => 
      array (
        'value' => 'vendor/mouf/integration.magento.moufgento/src/templates',
        'parametertype' => 'primitive',
        'type' => 'string',
        'metadata' => 
        array (
...
return rtrim(sys_get_temp_dir(), \'/\\\\\').\'/mouftwigtemplatemain_\'.$posixGetuid.str_replace(":", "", ROOT_PATH);',
  ...
  'userService' => 
  array (
    'class' => 'Mouf\\Integration\\Magento\\MagentoUserService',
    'external' => false,
    'weak' => false,
  ),
...
return rtrim(sys_get_temp_dir(), '/\\').'/mouftwigtemplatemain_'.$posixGetuid.str_replace(":", "", ROOT_PATH);
	 ...
	 */
	 public static function getDefaultRouter() {
	 	return MoufManager::getMoufManager()->get('defaultRouter');
	 }
	...
	/**
	 * @return Mouf\Integration\Magento\MagentoTemplate
	 */
	 public static function getMagentoTemplate() {
	 	return MoufManager::getMoufManager()->get('magentoTemplate');
	 }
	 ...
	 * @return Mouf\Html\Renderer\FileBasedRenderer
	 */
	 public static function getMoufgentoRenderer() {
	 	return MoufManager::getMoufManager()->get('moufgentoRenderer');
	 }
	...
	/**
	 * @return Mouf\Integration\Magento\MagentoUserService
	 */
